...
splashy.on('ready', () => {
    ...
    setInterval(function(){
      ...
      splashy.user.setPresence({ game: { name: 'RAINBOW' }, type: 0, status: 'dnd' });
    }, 10000)
});
        ...
        if (!rRole) return msg.channel.send('Cant find the specified role');
            ...
            msg.channel.send({
                embed: {
                    ...
                    author: { name: "Splashy Support Discord Server", url: 'https://discord.gg/5VZMTVP', icon_url: msg.guild.iconURL  },
    ...
    channel.send({
        embed: {
            ...
            },
            {
                ...
                value: '[HERE](https://discord.gg/5VZMTVP)',
                inline: true
            }, 
            {
                name: "Bot Prefix:",
